...
# --- Paths & metadata ---
SCRIPT_PATH="/private/home/francoisporcher/vjepa2/scripts/generate_kinetics_400_vjepa2_embeddings_distributed.py"
...
# --- Run job ---
echo "================= RUNNING SCRIPT =================="
srun torchrun --standalone --nproc_per_node=8 "$SCRIPT_PATH"
EXIT_CODE=$?
echo "==================================================="
